...
{
    /// <summary>
    /// Головна форма програми — забезпечує інтерфейс для перегляду, додавання,
    /// редагування та видалення географічних об'єктів: материків, країн, регіонів та міст.
    /// Також містить пошук, сортування, фільтрацію та роботу з файлом даних.
    /// </summary>
    public partial class MainForm : Form
    {
        ...
        /// <summary>
        /// Створює екземпляр головної форми і ініціалізує дані та обробники подій.
        /// </summary>
        public MainForm()
        {
            InitializeComponent();
        ...
        private void menuAbout_Click(object sender, EventArgs e)
        {
            MessageBox.Show(
                ...
                "- Подвійний клік: материк → показати країни цього материка; країна → показати її регіони; регіон → показати міста\n" +
